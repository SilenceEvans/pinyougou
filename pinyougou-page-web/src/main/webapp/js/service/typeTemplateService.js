...
app.service('typeTemplateService',function($http){
	...
	this.selectOptionTemplateList=function () {

		return $http.get("../typeTemplate/selectOptionTemplateList.do");
	};

	this.selectOptionTemplateName=function (id) {
		return $http.get("../typeTemplate/selectOptionTemplateName.do?id="+id);
	}
});
